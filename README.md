# 2022-12-09
현재 다른 배포 사이트인 fly.io를 찾아서 어떻게 올리는지 보고 있는 중이다.<br>
docker 파일을 배포 해야 해서 도커를 조금 보고 조금씩 진행 중이긴 한데 잘 되지 않는다<br>
현재 상태 : docker 이미지 변환 후 업로드 까지 완료 <br>
(DB :connection error) 로 인해 서버가 정상 작동하지 않는다 <br>
열심히 찾아보면서 고쳐봐야겠다.<br>
---------------------------------------------------------
